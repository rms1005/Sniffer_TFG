...
public class ElemCapCapture extends Element {
	...
	private static final long serialVersionUID = -8775026343471213461L;
	...
	private void setPromiscuousMode() {
		addContent(
				(new Element("Promiscuous_Modo")).setText(pOperation.validate(getPBCapture().getCapPromiscuousMode())));
	}
