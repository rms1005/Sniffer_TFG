...
public class Estadisticas extends JFrame {
	...
	private JFreeChart createChart(CategoryDataset dataset) {
		JFreeChart chart = ChartFactory.createBarChart3D("Link/Network/Transport Layer", "Tipo Protocolo",
				"Numero de paquetes", dataset, PlotOrientation.VERTICAL, true, true, false);
