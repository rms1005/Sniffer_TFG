 ...
 * @version 1.2
 */
/* 21: */ public class PreferenciasConfiguracion/* 22: */ extends JDialog
/* 23: */ {
...
///*  88:    */     this.jButton7 = new CBAbrirCarpeta(this.mediador, "Resultado");
		...
		/* 91:121 */ jPanel1Layout.setHorizontalGroup(/* 92:122 */ jPanel1Layout.createParallelGroup(1)
				/* 93:123 */ .add(jPanel1Layout.createSequentialGroup()/* 94:124 */ .addContainerGap()
						/* 95:125 */ .add(jPanel1Layout.createParallelGroup(1)/* 96:126 */ .add(this.jLabel4)
								/* 97:127 */ .add(this.jLabel3)/* 98:128 */ .add(this.jLabel2)
								/* 99:129 */ .add(this.jLabel1))

						/* 100:130 */ .addPreferredGap(0)
						/* 101:131 */ .add(jPanel1Layout.createParallelGroup(1, false)
								/* 102:132 */ .add(jTextField4, -2, 220, -2)/* 103:133 */ .add(jTextField3, -2, 220, -2)
		...
		/* 113: */
		/* 114:144 */ jPanel1Layout
				.setVerticalGroup(/* 115:145 */ jPanel1Layout.createParallelGroup(1)
						/* 116:146 */ .add(jPanel1Layout.createSequentialGroup()/* 117:147 */ .addContainerGap()
								/* 118:148 */ .add(jPanel1Layout.createParallelGroup(3)/* 119:149 */ .add(this.jLabel1)
										/* 120:150 */ .add(jTextField1, -2, -1, -2)
										/* 121:151 */ .add((CBAbrirCarpeta) this.jButton1))
								/* 122:152 */ .add(11, 11, 11)
								/* 123:153 */ .add(jPanel1Layout.createParallelGroup(3)/* 124:154 */ .add(this.jLabel2)
										/* 125:155 */ .add(jTextField2, -2, -1, -2)
										/* 126:156 */ .add((CBAbrirCarpeta) this.jButton2))
								/* 127:157 */ .add(14, 14, 14)
								/* 128:158 */ .add(jPanel1Layout.createParallelGroup(3)/* 129:159 */ .add(this.jLabel3)
										/* 130:160 */ .add(jTextField3, -2, -1, -2)
										/* 131:161 */ .add((CBAbrirCarpeta) this.jButton3))
								/* 132:162 */ .add(14, 14, 14)
								/* 133:163 */ .add(jPanel1Layout.createParallelGroup(3)/* 134:164 */ .add(this.jLabel4)
										/* 135:165 */ .add(jTextField4, -2, -1, -2)
										/* 136:166 */ .add((CBAbrirCarpeta) this.jButton4))
								.add(14, 14, 14)/* 137:167 */ .addContainerGap(-1, 32767)));
		/* 138: */
		...
		/* 153:182 */ layout.setHorizontalGroup(/* 154:183 */ layout.createParallelGroup(1)
				/* 155:184 */ .add(layout.createSequentialGroup()
						/* 156:185 */ .add(layout.createParallelGroup(2)
								/* 157:186 */ .add(layout.createSequentialGroup()/* 158:187 */ .addContainerGap()
										/* 159:188 */ .add(this.jButton6)/* 160:189 */ .addPreferredGap(0)
										/* 161:190 */ .add((CBAceptar) this.jButton5))
								/* 162:191 */ .add(1,
										layout.createSequentialGroup()/* 163:192 */ .addContainerGap()
												/* 164:193 */ .add(this.jPanel1, -2, -1, -2)))
						/* 165:194 */ .addContainerGap(11, 32767)));
		/* 166: */
		/* 167:196 */ layout
				.setVerticalGroup(/* 168:197 */ layout.createParallelGroup(1)
						/* 169:198 */ .add(layout.createSequentialGroup()/* 170:199 */ .addContainerGap()
								/* 171:200 */ .add(this.jPanel1, -2, -1, -2)/* 172:201 */ .add(21, 21, 21)
								/* 173:202 */ .add(layout.createParallelGroup(3)
										/* 174:203 */ .add((CBAceptar) this.jButton5)/* 175:204 */ .add(this.jButton6))
