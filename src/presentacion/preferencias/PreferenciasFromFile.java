...
public class PreferenciasFromFile extends JDialog {
	...
	private void initComponents() {
		...
		jPanel1.setBorder(BorderFactory.createTitledBorder("Captura desde fichero"));
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(1).add(jPanel1Layout.createSequentialGroup()
				...
				.add(jPanel1Layout.createParallelGroup(1, false)
						.add(jPanel1Layout.createSequentialGroup().add(jLabel1).addPreferredGap(0).add(jTextField11)
								.addPreferredGap(0).add((CBAbrirFichero) this.jButton7))
						.add(jPanel6, -2, -1, -2))
		...
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(1)
				.add(jPanel1Layout.createSequentialGroup().addContainerGap()
						.add(jPanel1Layout.createParallelGroup(3).add(jLabel1).add((CBAbrirFichero) this.jButton7)
								.add(jTextField11, -2, -1, -2))
						.addPreferredGap(0).add(jPanel6, -2, -1, -2).addContainerGap(-1, 32767)));
