...
public class PreferenciasInsercionCapturados extends JDialog {
	...
	private void initComponents() {
		...
		this.jPanel1.setBorder(BorderFactory.createTitledBorder(new LineBorder(new Color(153, 204, 255), 2, true), "",
				0, 0, new Font("Tahoma", 0, 11), new Color(153, 204, 255)));
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addContainerGap().addGroup(jPanel1Layout
						...
						.addGroup(jPanel1Layout.createSequentialGroup().addComponent(this.jLabel2, -1, 67, 32767)
								.addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
								.addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
										.addComponent(this.jRindet)
										.addGroup(jPanel1Layout.createSequentialGroup().addComponent(this.jRdet)
												.addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
						...
						.addGroup(GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
								.addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.TRAILING)
										.addGroup(GroupLayout.Alignment.LEADING,
												jPanel1Layout.createSequentialGroup().addComponent(this.jLabel3)
														.addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
														.addComponent(jComboBox1, 0, 532, 32767))
										.addGroup(GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
												.addComponent(this.jLabel1, -2, 80, -2)
												.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
												.addComponent(jTextField1, -2, 440, -2).addGap(18, 18, 18)
				...
				.setVerticalGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
						.addGroup(jPanel1Layout.createSequentialGroup().addGap(28, 28, 28)
								.addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
										.addComponent(this.jLabel3).addComponent(jComboBox1, -2, -1, -2))
								.addGap(49, 49, 49)
								.addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
										.addComponent(this.jLabel1).addComponent(jTextField1, -2, -1, -2)
										.addComponent((CBAbrirFichero) this.jBAbrirExportacion, -2, 31, -2))
								.addGap(29, 29, 29).addComponent(this.jRunicas).addGap(14, 14, 14)
								.addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
										.addComponent(this.jLabel2).addComponent(this.jRdet)
										.addComponent(this.jTextField2, -2, -1, -2))
								.addGap(18, 18, 18).addComponent(this.jRindet).addContainerGap(19, 32767)));

		GroupLayout layout = new GroupLayout(getContentPane());
		getContentPane().setLayout(layout);
		layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup().addContainerGap().addComponent(this.jPanel1, -2, -1, -2)
				...
				.addGroup(layout.createSequentialGroup().addGap(121, 121, 121)
						...
						.addComponent((CBAceptar) this.jBcancelar, -2, 141, -2).addGap(161, 161, 161)));

		layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(
				GroupLayout.Alignment.TRAILING,
				layout.createSequentialGroup().addContainerGap().addComponent(this.jPanel1, -2, -1, -2).addGroup(layout
				...
				.addGroup(layout.createSequentialGroup()
						.addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
								...
								.addGroup(layout.createSequentialGroup().addGap(150, 150, 150)
										.addComponent((CBAceptar) this.jBInsertar, -2, 90, -2).addGap(140, 140, 140)
