 ...
 * @version 1.2
 */
public class PreferenciasCaptura extends JDialog {

	private static final long serialVersionUID = 4864127438678440126L;
	...
	private void initComponents() {
		...
		jPanel3Layout.setHorizontalGroup(jPanel3Layout.createParallelGroup(1).add(jPanel3Layout.createSequentialGroup()
				.addContainerGap().add(jLabel9, -1, 490, 32767).addContainerGap()));
		jPanel3Layout.setVerticalGroup(jPanel3Layout.createParallelGroup(1).add(jLabel9));
		getContentPane().add(jPanel3, "South");

		jPanel1.setBorder(BorderFactory.createTitledBorder("Captura"));
		jPanel6.setBorder(BorderFactory.createTitledBorder(null, "Filtro", 0, 0, new Font("Times New Roman", 0, 11)));
		...
		jPanel7Layout.setHorizontalGroup(jPanel7Layout.createParallelGroup(1)
				.add(jPanel7Layout.createSequentialGroup().addContainerGap().add(jCheckBox2).addPreferredGap(0)
						.add(jTextField2, -1, 275, 32767).add(27, 27, 27).add((CBFiltroAyuda) this.jButton1)
						.addContainerGap()));

		jPanel7Layout.setVerticalGroup(jPanel7Layout.createParallelGroup(1).add(jPanel7Layout.createParallelGroup(3)
				.add(jCheckBox2).add(jTextField2, -2, -1, -2).add((CBFiltroAyuda) this.jButton1)));

		GroupLayout jPanel6Layout = new GroupLayout(jPanel6);
		jPanel6.setLayout(jPanel6Layout);
		jPanel6Layout.setHorizontalGroup(jPanel6Layout.createParallelGroup(1)
				.add(jPanel6Layout.createSequentialGroup().add(jPanel6Layout.createParallelGroup(1)
						.add(jPanel6Layout.createSequentialGroup().addContainerGap().add(jLabel2).addPreferredGap(0)
								.add(jTextField1, -2, 99, -2).add(14, 14, 14).add(jLabel3).addPreferredGap(0)
								.add(jComboBox2, -2, 100, -2).addPreferredGap(0, 22, 32767).add(jLabel4)
								.addPreferredGap(0).add(jComboBox3, -2, 100, -2))
						.add(jPanel7, -1, -1, 32767)).addContainerGap()));

		jPanel6Layout.setVerticalGroup(jPanel6Layout.createParallelGroup(1)
				.add(jPanel6Layout.createSequentialGroup()
						.add(jPanel6Layout.createParallelGroup(3).add(jTextField1, -2, -1, -2).add(jLabel2)
								.add(jComboBox3, -2, -1, -2).add(jLabel4).add(jComboBox2, -2, -1, -2).add(jLabel3))
						.addPreferredGap(0, 10, 32767).add(jPanel7, -2, -1, -2).addContainerGap()));
		...
		jCheckBox1.setText("Capturar paquetes en modo promíscuo");
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(1)
				.add(jPanel1Layout.createSequentialGroup().add(jPanel1Layout.createParallelGroup(1)
						.add(jPanel1Layout.createSequentialGroup().addContainerGap()
								.add(jPanel1Layout.createParallelGroup(1).add(jCheckBox1, -2, 253, -2)
										.add(jPanel1Layout.createSequentialGroup().add(jLabel1).addPreferredGap(0)
												.add(jComboBox1, 0, 399, 32767))))
						.add(jPanel6, -1, -1, 32767)).addContainerGap()));

		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(1)
				.add(jPanel1Layout.createSequentialGroup().addContainerGap()
						.add(jPanel1Layout.createParallelGroup(3).add(jLabel1).add(jComboBox1, -2, -1, -2))
						.add(15, 15, 15).add(jCheckBox1).addPreferredGap(0, 17, 32767).add(jPanel6, -2, -1, -2)));

		jPanel4.setBorder(BorderFactory.createTitledBorder("Fichero/os Capturado/os"));
		...
		jCheckBox7.setText("Parar después de");
		jCheckBox7.setBorder(BorderFactory.createEmptyBorder(0, 0, 0, 0));
		...
		jPanel9Layout.setHorizontalGroup(jPanel9Layout.createParallelGroup(1).add(jPanel9Layout.createSequentialGroup()
				.addContainerGap()
				.add(jPanel9Layout
						.createParallelGroup(1).add(jCheckBox7).add(jCheckBox6).add(jCheckBox5).add(jCheckBox4))
				.add(10, 10, 10)
				.add(jPanel9Layout.createParallelGroup(1).add(jTextField6, -1, 65, 32767)
						.add(jTextField7, -1, 65, 32767).add(jTextField5, -1, 65, 32767).add(jTextField4, -2, 65, -2))
				.addPreferredGap(0)
				.add(jPanel9Layout.createParallelGroup(1).add(jLabel7).add(jLabel6).add(jPanel9Layout
						.createParallelGroup(1, false).add(jComboBox5, 0, -1, 32767).add(jComboBox4, 0, 86, 32767)))
				.add(25, 25, 25)));
		jPanel9Layout
				.setVerticalGroup(
						jPanel9Layout
								.createParallelGroup(1).add(
										jPanel9Layout.createSequentialGroup()
												.add(jPanel9Layout.createParallelGroup(3).add(jComboBox4, -2, -1, -2)
														.add(jCheckBox4).add(jTextField4, -2, -1, -2))
												.addPreferredGap(0)
												.add(jPanel9Layout.createParallelGroup(3).add(jCheckBox5)
														.add(jComboBox5, -2, -1, -2).add(jTextField5, -2, -1, -2))
												.addPreferredGap(0)
												.add(jPanel9Layout.createParallelGroup(3).add(jCheckBox6).add(jLabel6)
														.add(jTextField6, -2, -1, -2))
												.addPreferredGap(0, -1, 32767).add(jPanel9Layout.createParallelGroup(3)
														.add(jCheckBox7).add(jLabel7).add(jTextField7, -2, -1, -2))));

		GroupLayout jPanel8Layout = new GroupLayout(jPanel8);
		jPanel8.setLayout(jPanel8Layout);
		jPanel8Layout.setHorizontalGroup(jPanel8Layout.createParallelGroup(1).add(jPanel8Layout.createSequentialGroup()
				.add(45, 45, 45).add(jPanel9, -2, -1, -2).addContainerGap(94, 32767)));
		jPanel8Layout.setVerticalGroup(jPanel8Layout.createParallelGroup(1).add(jPanel9, -2, -1, -2));

		GroupLayout jPanel4Layout = new GroupLayout(jPanel4);
		jPanel4.setLayout(jPanel4Layout);
		jPanel4Layout.setHorizontalGroup(jPanel4Layout.createParallelGroup(1).add(jPanel4Layout.createSequentialGroup()
				.addContainerGap()
		...
		jPanel5.setBorder(BorderFactory.createTitledBorder("Parar Captura"));
		...
		jPanel5Layout.setHorizontalGroup(jPanel5Layout.createParallelGroup(1)
				.add(jPanel5Layout.createSequentialGroup().addContainerGap()
						.add(jPanel5Layout.createParallelGroup(1).add(jCheckBox8).add(jCheckBox9).add(jCheckBox10))
						.add(20, 20, 20)
						.add(jPanel5Layout.createParallelGroup(1, false).add(jTextField8, -1, 65, 32767)
								.add(jTextField9).add(jTextField10))
						.addPreferredGap(0).add(jPanel5Layout.createParallelGroup(1).add(jLabel8)
								.add(jComboBox6, 0, 95, 32767).add(jComboBox7, 0, 95, 32767))
						.addContainerGap()));
		jPanel5Layout.setVerticalGroup(jPanel5Layout.createParallelGroup(1).add(jPanel5Layout.createSequentialGroup()
				.add(jPanel5Layout.createParallelGroup(3).add(jCheckBox8).add(jLabel8).add(jTextField8, -2, -1, -2))
				.addPreferredGap(0)
				.add(jPanel5Layout.createParallelGroup(3).add(jCheckBox9).add(jTextField9, -2, -1, -2).add(jComboBox6,
						-2, -1, -2))
				.addPreferredGap(0).add(jPanel5Layout.createParallelGroup(3).add(jCheckBox10)
						.add(jTextField10, -2, -1, -2).add(jComboBox7, -2, -1, -2))
				.addContainerGap(-1, 32767)));
		if (this.tipo) {
				...
				.setHorizontalGroup(
						jPanel2Layout.createParallelGroup(1)
								.add(jPanel2Layout.createSequentialGroup().addContainerGap()
										.add(jPanel2Layout
												.createParallelGroup(1).add(2,
														jPanel2Layout.createSequentialGroup().add(jPanel5, -2, -1, -2)
																.addPreferredGap(0, 47, 32767)
																.add(jPanel2Layout.createParallelGroup(2, false)
																		.add((CBAbrirFichero) this.jButton6, -1, -1,
																				32767)
																		.add(jButton4, -1, -1, 32767))
																.addPreferredGap(0)
																.add(jPanel2Layout.createParallelGroup(1)
																		.add((CBGuardarFichero) this.jButton5)
		...
		jPanel2Layout.setVerticalGroup(jPanel2Layout.createParallelGroup(1).add(jPanel2Layout.createSequentialGroup()
				.addContainerGap().add(jPanel1, -2, -1, -2).addPreferredGap(0).add(jPanel4, -2, -1, -2)
				.add(jPanel2Layout.createParallelGroup(1)
						.add(jPanel2Layout.createSequentialGroup().add(16, 16, 16)
								.add(jPanel2Layout.createParallelGroup(3).add((CBGuardarFichero) this.jButton5)
										.add((CBAbrirFichero) this.jButton6))
								.addPreferredGap(0, 60, 32767)
								.add(jPanel2Layout.createParallelGroup(3).add((CBAceptar) this.jButton3).add(jButton4))
								.addContainerGap(22, 32767))
						.add(jPanel2Layout.createSequentialGroup().addPreferredGap(0).add(jPanel5, -2, -1, -2)
								.addContainerGap()))));
	...
	public static String getDispositivo() {
		return Dispo[jComboBox1.getSelectedIndex()] + "\n " + jComboBox1.getSelectedItem();
	}
