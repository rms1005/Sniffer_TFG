...
public class Fcaptura extends JFrame {
	...
	private void initComponents() {
		...
		this.jPanel1.setBorder(new TitledBorder("CapturedPackets"));
		...
		this.jButton2.setIcon(new ImageIcon(FachadaFicheroDirectorios.getdirectorioData("DIR_IMAGES")
				+ System.getProperty("file.separator") + "visualframe.png"));
		...
		getContentPane().add(this.jButton2, new AbsoluteConstraints(640, 260, 50, 30));
