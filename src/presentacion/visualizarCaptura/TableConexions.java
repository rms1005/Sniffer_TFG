...
public class TableConexions {
	...
	public void DatosTablaConexion(String numeropaquete, String time, String ipsrc, String ipdest, String portsrc,
			String portdest, String paquetes) {
		this.modelo.addRow(numeropaquete, time, ipsrc, ipdest, portsrc, portdest, paquetes);
	}
