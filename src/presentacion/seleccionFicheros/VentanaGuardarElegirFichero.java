		...
		if (returnVal == 0) {
			...
			if (sobreescribir == "Si") {
				...
				if (tip.equals("Guardar fichero capturado...")) {
					...
					System.out.println((new StringBuilder("Exportar fichero......=> ")).append(file.getName())
							.append("   ").append(file.getPath()).toString());
				} else if (tip.equals("Browse...")) {
					mediador.setPrefCapFichero(fRuta);
					System.out.println((new StringBuilder("Fichero donde se guardara la captura...=> "))
							.append(file.getName()).append("   ").append(file.getPath()).toString());
				} else if (tip.equals("Browse...FromFile")) {
					...
					System.out.println((new StringBuilder("Seleccion de fichero .bat .....=> ")).append(file.getName())
							.append("   ").append(file.getPath()).toString());
				} else if (tip.equals("GenerarFromFileXML")) {
					mediador.setExportFromFileXML(fRuta);
					System.out.println((new StringBuilder("Seleccion de fichero .XML .....=> ")).append(file.getName())
							.append("   ").append(file.getPath()).toString());
				} else if (tip.equals("GenerarFromFileXMLSaveXML")) {
					...
					System.out.println((new StringBuilder("Guardar definicion de protocolo...=> "))
							.append(file.getName()).append("   ").append(file.getAbsolutePath()).toString());
				} else if (tip.equals("DetallePaquetes")) {
					mediador.PrefPacketDetGuardarXML(7, fRuta);
					System.out.println((new StringBuilder("Guardar fichero de preferecias de detalles...=> "))
							.append(file.getName()).append("   ").append(file.getPath()).toString());
				}
//                if(tip.equals("ResultadoIntrusos"))
//                {
