...
public class VentanaAcercaDe extends JDialog {
	...
	private void initComponents() {
		...
		jPanel4Layout.setHorizontalGroup(jPanel4Layout.createParallelGroup(1).add(jPanel4Layout.createSequentialGroup()
				.addContainerGap()
				.add(jPanel4Layout.createParallelGroup(1).add(this.jLabel7).add(jPanel4Layout.createSequentialGroup()
						.add(this.jLabel5)
						.add(jPanel4Layout.createParallelGroup(1)
								.add(jPanel4Layout.createSequentialGroup().add(19, 19, 19)
										.add(jPanel4Layout.createParallelGroup(1).add(this.jLabel8).add(this.jLabel9)))
								.add(jPanel4Layout.createSequentialGroup().add(29, 29, 29).add(this.jLabel6)))))
		...
		jPanel4Layout.setVerticalGroup(jPanel4Layout.createParallelGroup(1)
				.add(jPanel4Layout.createSequentialGroup().addContainerGap()
						.add(jPanel4Layout.createParallelGroup(3).add(this.jLabel5).add(this.jLabel6))
						.addPreferredGap(0).add(this.jLabel7).addPreferredGap(0).add(this.jLabel8).addPreferredGap(0)
						.add(this.jLabel9).addContainerGap(-1, 32767)));
		...
		layout.setHorizontalGroup(layout.createParallelGroup(1).add(layout.createSequentialGroup().add(19, 19, 19)
				.add(layout.createParallelGroup(2).add(1, this.jPanel1, -1, -1, 32767)
						.add(1, this.jPanel4, -1, -1, 32767)
						.add(layout.createSequentialGroup()
								.add(layout.createParallelGroup(1)
										.add(layout.createSequentialGroup().add(this.jLabel11).addPreferredGap(0)
												.add(this.jLabel13, -2, 56, -2))
										.add(layout.createSequentialGroup().add(this.jLabel10).addPreferredGap(0)
												.add(this.jLabel12, -2, 70, -2)))
								.addPreferredGap(0, 59, 32767).add(this.jButton1).add(15, 15, 15)))
				.add(363, 363, 363)));
		layout.setVerticalGroup(
				layout.createParallelGroup(
						1).add(
								layout.createSequentialGroup().addContainerGap().add(this.jPanel1, -2, 154, -2)
										.addPreferredGap(0).add(this.jPanel4, -2, -1, -2).add(16, 16, 16)
										.add(layout
												.createParallelGroup(1).add(
														layout.createSequentialGroup()
																.add(layout.createParallelGroup(3).add(this.jLabel10)
																		.add(this.jLabel12, -2, 22, -2))
																.addPreferredGap(0)
																.add(layout.createParallelGroup(3).add(this.jLabel11)
																		.add(this.jLabel13, -2, 20, -2)))
												.add(this.jButton1))
