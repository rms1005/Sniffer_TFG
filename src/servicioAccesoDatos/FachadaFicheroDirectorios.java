...
public class FachadaFicheroDirectorios extends FachadaFichero
{
    ...
    public FachadaFicheroDirectorios(String nombreRutaF)
        throws IOException
    {
        ...
        try
        {
            ...
            for(int j = 0; j < etiAtriFichero.length; j++)
            {
                ...
                if(pos > -1)
                {
                    ...
                    String aux2 = etiAtriFichero[j].toString().substring(pos + 1, etiAtriFichero[j].toString().length());
                    aux2 = aux2.replace("\\\\", "\\");
                    aux2 = aux2.replace("\\:", ":");
    ...
    public static String nomdir[] = {
        "DIR_PARAMETRIZACION", "DIR_CAPTURAS", "DIR_RULES", "DIR_EXPORTACIONES", "DIR_SCRIPTS", "DIR_DEFINICIONES", "DIR_INTRUSO"
    };
    public static String dirData[];
    public static String nomdirData[] = {
        "DIR_PROPERTIES", "DIR_IMAGES", "DIR_HELP"
    };
    ...
    static 
    {
        barra = "/";
        dir = (new String[] {
            (new File((new StringBuilder(".")).append(barra).append("files").append(barra).append("parametrizacion").toString())).getAbsolutePath(), (new File((new StringBuilder(".")).append(barra).append("files").append(barra).append("capturas").toString())).getAbsolutePath(), (new File((new StringBuilder(".")).append(barra).append("files").append(barra).append("rules").toString())).getAbsolutePath(), (new File((new StringBuilder(".")).append(barra).append("files").append(barra).append("exportaciones").toString())).getAbsolutePath(), (new File((new StringBuilder(".")).append(barra).append("files").append(barra).append("scripts").toString())).getAbsolutePath(), (new File((new StringBuilder(".")).append(barra).append("files").append(barra).append("definiciones").toString())).getAbsolutePath(), (new File((new StringBuilder(".")).append(barra).append("files").append(barra).append("intruso").toString())).getAbsolutePath()
        });
        dirData = (new String[] {
            (new File((new StringBuilder(".")).append(barra).append("data").append(barra).append("properties").toString())).getAbsolutePath(), (new File((new StringBuilder(".")).append(barra).append("data").append(barra).append("images").toString())).getAbsolutePath(), (new File((new StringBuilder(".")).append(barra).append("data").append(barra).append("help").toString())).getAbsolutePath()
        });
    }
}
