...
@Header
public class Igmp extends JHeaderMap<Igmp> {
	...
	public enum IgmpType {
		...
		/** The Constant MEMBERSHIP_QUERY_ID. */
		public final static int MEMBERSHIP_QUERY_ID = 0x11;
		
		/** The Constant V1_MEMBERSHIP_REPORT_ID. */
		public final static int V1_MEMBERSHIP_REPORT_ID = 0x12;
		
		/** The Constant V2_MEMBERSHIP_REPORT_ID. */
		public final static int V2_MEMBERSHIP_REPORT_ID = 0x16;
		
		/** The Constant V2_LEAVE_GROUP_ID. */
		public final static int V2_LEAVE_GROUP_ID = 0x17;
		
		/** The Constant V3_MEMBERSHIP_REPORT_ID. */
		public final static int V3_MEMBERSHIP_REPORT_ID = 0x22;
	...
	@Header(id = IgmpType.MEMBERSHIP_QUERY_ID, nicname = "query")
	public class Query extends JSubHeader<Igmp> implements JHeaderChecksum {
	...
	@Header(id = IgmpType.V1_MEMBERSHIP_REPORT_ID, nicname = "memRep1")
	public class MembershipReportv1 extends JSubHeader<Igmp> implements JHeaderChecksum {
	...
	@Header(id = IgmpType.V2_MEMBERSHIP_REPORT_ID, nicname = "memRep2")
	public class MembershipReportv2 extends JSubHeader<Igmp> implements JHeaderChecksum {
	...
	@Header(id = IgmpType.V3_MEMBERSHIP_REPORT_ID, nicname = "memRep3")
	public class MembershipReportv3 extends JSubHeader<Igmp> implements JHeaderChecksum {
