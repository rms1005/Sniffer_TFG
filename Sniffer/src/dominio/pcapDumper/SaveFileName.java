...
public class SaveFileName {
	...
	public String getNameTimeTmp() {
		String aux = (new StringBuilder(String.valueOf(getNameFile()))).append("_").append(getDateTime()).append("_")
				.append(getNext()).append(".tmp").toString();
		return aux;
	}
	...
	public void saveState(boolean auxState) {
		stateCaptura.setFile(
				(new StringBuilder(String.valueOf(getPath()))).append(getSeparator()).append(getNameFile()).toString());
		...
		stateCaptura.setLastCaptureFile(
				(new StringBuilder(String.valueOf(getNameFile()))).append(getNameExtension()).toString());
	...
	public void saveStateMulti(boolean auxState) {
		stateCaptura.setFile((new StringBuilder(String.valueOf(getPath()))).append(getSeparator()).append(getNameFile())
				.append("_").append(getDateTime()).toString());
		stateCaptura.setLocate(getPath());
		stateCaptura.setName(
				(new StringBuilder(String.valueOf(getNameFile()))).append("_").append(getDateTime()).toString());
		stateCaptura.setExtension(getNameExtension());
