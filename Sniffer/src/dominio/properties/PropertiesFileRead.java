...
public class PropertiesFileRead {
	...
	public String getDefaultFileSniffer() {
		return (new StringBuilder(String.valueOf(FachadaFicheroDirectorios.getdirectorioData("DIR_PROPERTIES"))))
				.append(System.getProperty("file.separator")).append("sniffer.property").toString();
	}
