		...
		if (returnVal == 0) {
			...
			if (file.exists()) {
				if (tip.equals("Abrir fichero de Capturas...")) {
					...
					System.out.println((new StringBuilder("Abrir fichero de Capturas...=> ")).append(file.getName())
				...
				if (tip.equals("Abrir fichero de Capturas desde fichero...")) {
					...
					System.out.println((new StringBuilder("Cargar fichero de preferecias...=> ")).append(file.getName())
							.append("   ").append(file.getPath()).toString());
				}
				if (tip.equals("Cargar fichero de preferecias..."))
					System.out.println((new StringBuilder("Cargar fichero de preferecias...=> ")).append(file.getName())
				...
				if (tip.equals("BrowseInicioCaptura")) {
					...
					System.out.println((new StringBuilder("Cargar fichero de preferencia de captura...=> "))
							.append(file.getName()).append("   ").append(file.getPath()).toString());
				}
				if (tip.equals("AbrirFicheroXMLFromFile")) {
					mediador.PrefFFLeerXML(fRuta);
					System.out.println((new StringBuilder("Cargar fichero de preferencia desde fichero...=> "))
							.append(file.getName()).append("   ").append(file.getPath()).toString());
				}
				if (tip.equals("GenerarBatPreferencias")) {
					mediador.setPrefGenFicheroPref(fRuta);
					System.out.println((new StringBuilder("Selecci\363n de fichero de preferencias...=> "))
							.append(file.getName()).append("   ").append(file.getPath()).toString());
				}
				if (tip.equals("GenerarFromFileXML")) {
					mediador.setExportFromFilePref(fRuta);
					System.out.println((new StringBuilder("Selecci\363n de fichero pcap o Meta...=> "))
							.append(file.getName()).append("   ").append(file.getPath()).toString());
				}
				if (tip.equals("GenerarFromFileXMLOpenXML")) {
				...
				if (tip.equals("AbrirDefinicionProtocolo")) {
					...
					System.out.println((new StringBuilder("Selecci\363n de fichero XML...=> ")).append(file.getName())
							.append("   ").append(file.getPath()).toString());
				}
				if (tip.equals("AbrirDefinicionProtocoloInsercion")) {
				...
				if (tip.equals("Abrir fichero de Capturas Insercion...")) {
					...
					System.out.println((new StringBuilder("Selecci\363n de fichero pcap...=> ")).append(file.getName())
							.append("   ").append(file.getPath()).toString());
				}
//                if(tip.equals("CapturaIntrusos"))
//                {
